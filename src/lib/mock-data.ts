...
export const navItems = [
  { to: "/", label: "פרויקטים" },
  { to: "/project", label: "סקירת פרויקט" },
  { to: "/bom", label: "טבלת BOM" },
  { to: "/upload-bom", label: "טעינת BOM" },
  { to: "/quality", label: "איכות BOM" },
  { to: "/china-quote", label: "מחירון סין" },
  { to: "/rep-quote", label: "נציגים רשמיים" },
  { to: "/versions", label: "גרסאות" },
  { to: "/changes", label: "השוואת שינויים" },
  { to: "/export", label: "דוחות וייצוא" },
  { to: "/files", label: "קבצי פרויקט" },
